...
Component({
    ...
    lifetimes: {
        attached() {
            ...
            this.setData({
                lowVision: this.compareVersion(version, '2.16.2') == -1,
                componentReady: true
            })
        },
        ready() {
    ...
    methods: {
        ...
        cancel() {
            ...
            this.triggerEvent('signcancel')
            this.hide()
        },
        // 确定  
        confirm: function () {
            // console.log(this.createImg(),8888)
            this.createImg()
            // this.hide()
            // this.triggerEvent('signconfirm', params)
        },
                ...
                if (res.tempFilePath) {
                  ...
                  wx.getFileSystemManager().readFile({
                    ...
                    success: file =>{
                      ...
                      that.triggerEvent('signconfirm', params)
                      that.hide()
